...
class ProjectedMapsInfo_Request:
    def __init__(
        self,
        *,
...
class ProjectedMapsInfo_Response:
...
class ProjectedMapsInfo:
    Request: TypeAlias = ProjectedMapsInfo_Request
    Response: TypeAlias = ProjectedMapsInfo_Response
